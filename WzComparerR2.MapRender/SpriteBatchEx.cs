...
namespace WzComparerR2.MapRender
{
    public class SpriteBatchEx : SpriteBatch
    {
        ...
        {
            Texture2D pixel = new Texture2D(this.GraphicsDevice, 1, 1, 1, TextureUsage.None, SurfaceFormat.Color);
        ...
        {
            IEnumerable<char> e = Methods.CreateCharEnumerator(text, startIndex, length);
        ...
        {
            IEnumerable<char> e = Methods.CreateCharEnumerator(stringBuilder, startIndex, length);
            DrawStringEx(xnaFont, e, location, color,origin, 0);
        }
