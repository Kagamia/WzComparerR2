...
namespace WzComparerR2.MapRender
{
    public class XnaFont : IDisposable
    {
        ...
        public XnaFont(GraphicsDevice graphicsDevice, Font baseFont)
        {
            ...
            this.textureBuffer = new Texture2D(graphicsDevice, 1024, 1024, 0, TextureUsage.None, SurfaceFormat.Color);
        ...
        {
            return MeasureString(Methods.CreateCharEnumerator(text, startIndex, length));
        }

        public Vector2 MeasureString(StringBuilder stringBuilder, int startIndex, int length)
        {
            return MeasureString(Methods.CreateCharEnumerator(stringBuilder, startIndex, length));
        }
        ...
        private Rectangle CreateCharBuffer(char c)
        {
            ...
            {
                IntPtr source = (IntPtr)((int)data.Scan0 + data.Stride * i);
            ...
            textureBuffer.SetData<byte>(0, rect, b, 0, b.Length, SetDataOptions.None);
        ...
        private void RebuildGdiBuffer(int height)
        {
            ...
            gdiBuffer = new Bitmap(1024, height, PixelFormat.Format32bppArgb);
            gdiBufferX = 0;
        ...
        {
            uint[] ary = new uint[textureBuffer.Width * textureBuffer.Height];
            textureBuffer.SetData<uint>(ary);
            ary = null;
        }
        ...
        public static FontFamily LoadFromFile(string fontFileName)
        {
            try
            {
                PrivateFontCollection font = new PrivateFontCollection();
                font.AddFontFile(fontFileName);
                privateFonts.Add(font);
        ...
        private static List<PrivateFontCollection> privateFonts = new List<PrivateFontCollection>();
    }
}
